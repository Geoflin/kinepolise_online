...
foreach ($pdo_kinepolise->query('SELECT DateSeanceBegin FROM `kinepolise_cinema2_seance_cinema1` WHERE FilmName LIKE "'.$_POST['FilmName'].'" ', PDO::FETCH_ASSOC) as $DateSeanceBegin) {
