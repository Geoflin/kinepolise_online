  ...
  <?php 
  foreach ($pdo_kinepolise->query('SELECT SalleName FROM kinepolise_cinema2_infos_cinema1', PDO::FETCH_ASSOC) as $Salle) { ?>
...
$pdo_kinepolise = new PDO('mysql:host=us-cdbr-east-04.cleardb.com;dbname=heroku_c4414696a201e4e', 'b37053e2dac347', '18a212b7');
  foreach ($pdo_kinepolise->query('SELECT * FROM kinepolise_cinema2_seance_cinema1 WHERE SalleName= "'.$_POST['SalleNameTest'].'" ', PDO::FETCH_ASSOC) as $FilmSalle) {
