...
foreach ($pdo_kinepolise->query('SELECT DateSeanceBegin FROM `kinepolise_cinema1_seance_cinema1` WHERE `kinepolise_cinema1_seance_cinema1`.`Id` = "'.$Id_modif.'" ', PDO::FETCH_ASSOC) as $DateSeanceBegin) {
...
$sql = "UPDATE `kinepolise_cinema1_seance_cinema1` SET `DateSeanceEnd` = '".$DateFinSeance."' WHERE `kinepolise_cinema1_seance_cinema1`.`Id` = '".$Id_modif."' ";
