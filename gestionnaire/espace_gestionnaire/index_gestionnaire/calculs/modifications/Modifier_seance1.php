...
//on calcul et ajoute date de fin séance
                  ...
                  $pdo_kinepolise->exec("SET CHARACTER SET utf8");
                                         $sql = "UPDATE `kinepolise_cinema1_seance_cinema1` SET `FilmName` = '".$_POST['FilmName']."', `DateSeanceBegin` = '".$fusionDateBegin_AjouterSeance."', `SalleName` = '".$_POST['SalleName']."' WHERE `kinepolise_cinema1_seance_cinema1`.`Id` = '".$Id_modif."' ";
